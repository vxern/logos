...
const categories: RoleCategory[] = [
	...
	},
	{
		...
		collection: {
			...
			lists: {
				'Armenian': [
					{ id: 'roles.ethnicity.languages.armenian.roles.aragatsotn' },
					{ id: 'roles.ethnicity.languages.armenian.roles.ararat' },
					{ id: 'roles.ethnicity.languages.armenian.roles.armavir' },
					{ id: 'roles.ethnicity.languages.armenian.roles.gegharkunik' },
					{ id: 'roles.ethnicity.languages.armenian.roles.kotayk' },
					{ id: 'roles.ethnicity.languages.armenian.roles.lorri' },
					{ id: 'roles.ethnicity.languages.armenian.roles.shirak' },
					{ id: 'roles.ethnicity.languages.armenian.roles.syunik' },
					{ id: 'roles.ethnicity.languages.armenian.roles.tavush' },
					{ id: 'roles.ethnicity.languages.armenian.roles.vayotsDzor' },
					{ id: 'roles.ethnicity.languages.armenian.roles.yerevan' },
				],
				'Romanian': [
					{ id: 'roles.ethnicity.languages.romanian.roles.banat' },
					{ id: 'roles.ethnicity.languages.romanian.roles.basarabia' },
					{ id: 'roles.ethnicity.languages.romanian.roles.bucovina' },
					{ id: 'roles.ethnicity.languages.romanian.roles.crisana' },
					{ id: 'roles.ethnicity.languages.romanian.roles.dobrogea' },
					{ id: 'roles.ethnicity.languages.romanian.roles.maramures' },
					{ id: 'roles.ethnicity.languages.romanian.roles.moldova' },
					{ id: 'roles.ethnicity.languages.romanian.roles.muntenia' },
					{ id: 'roles.ethnicity.languages.romanian.roles.oltenia' },
					{ id: 'roles.ethnicity.languages.romanian.roles.transilvania' },
				],
			},
		},
	},
