...
const category: RoleCategory = {
	type: "single",
	id: "roles.learning",
	color: constants.colours.lightGray,
	emoji: constants.emojis.roles.categories.learning.category,
	collection: {
		type: "implicit",
		list: [
			{
				id: "roles.learning.roles.correctMe",
				emoji: constants.emojis.roles.categories.learning.correctMe,
				snowflakes: {
			...
			},
			{
				...
				emoji: constants.emojis.roles.categories.learning.doNotCorrectMe,
				snowflakes: {
			...
			},
			{
				...
				emoji: constants.emojis.roles.categories.learning.classroomAttendee,
				snowflakes: {
			...
			},
			{
				...
				emoji: constants.emojis.roles.categories.learning.dailyPhrase,
				snowflakes: {
			...
			},
			{
				...
				emoji: constants.emojis.roles.categories.learning.voicechatter,
				snowflakes: {
