					...
					"432173040638623746": [
						{
							...
							emoji: constants.emojis.roles.categories.personalisation.orthography.idinist,
				...
				list: [
					{
						...
						emoji: constants.emojis.roles.categories.personalisation.gender.male,
						snowflakes: {
					...
					},
					{
						...
						emoji: constants.emojis.roles.categories.personalisation.gender.female,
						snowflakes: {
					...
					},
					{
						...
						emoji: constants.emojis.roles.categories.personalisation.gender.nonbinary,
						snowflakes: {
				...
				list: [
					{
						...
						emoji: constants.emojis.roles.categories.personalisation.abroad.diasporan,
						snowflakes: {
