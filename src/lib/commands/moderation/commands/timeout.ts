...
import { handleSetTimeout, handleSetTimeoutAutocomplete } from 'logos/src/lib/commands/moderation/commands/timeout/set.ts';
import {
	handleClearTimeout,
	handleClearTimeoutAutocomplete,
} from 'logos/src/lib/commands/moderation/commands/timeout/clear.ts';
import { CommandTemplate } from 'logos/src/lib/commands/command.ts';
import { duration, reason, user } from 'logos/src/lib/commands/parameters.ts';
