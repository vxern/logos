...
import { GuildBanRemoveEventLogger } from "logos/journalling/discord/guild-ban-remove";
import { GuildMemberAddEventLogger } from "logos/journalling/discord/guild-member-add";
import { GuildMemberRemoveEventLogger } from "logos/journalling/discord/guild-member-remove";
import { MessageDeleteEventLogger } from "logos/journalling/discord/message-delete";
import { MessageUpdateEventLogger } from "logos/journalling/discord/message-update";
import { EntryRequestAcceptEventLogger } from "logos/journalling/logos/entry-request-accept";
import { EntryRequestRejectEventLogger } from "logos/journalling/logos/entry-request-reject";
import { EntryRequestSubmitEventLogger } from "logos/journalling/logos/entry-request-submit";
import { InquiryOpenEventLogger } from "logos/journalling/logos/inquiry-open";
import { MemberTimeoutAddEventLogger } from "logos/journalling/logos/member-timeout-add";
import { MemberTimeoutRemoveEventLogger } from "logos/journalling/logos/member-timeout-remove";
import { MemberWarnAddEventLogger } from "logos/journalling/logos/member-warn-add";
import { MemberWarnRemoveEventLogger } from "logos/journalling/logos/member-warn-remove";
import { PraiseAddEventLogger } from "logos/journalling/logos/praise-add";
import { PurgeBeginEventLogger } from "logos/journalling/logos/purge-begin";
import { PurgeEndEventLogger } from "logos/journalling/logos/purge-end";
import { ReportSubmitEventLogger } from "logos/journalling/logos/report-submit";
import { ResourceSendEventLogger } from "logos/journalling/logos/resource-send";
import { SlowmodeDisableEventLogger } from "logos/journalling/logos/slowmode-disable";
import { SlowmodeDowngradeEventLogger } from "logos/journalling/logos/slowmode-downgrade";
import { SlowmodeEnableEventLogger } from "logos/journalling/logos/slowmode-enable";
import { SlowmodeUpgradeEventLogger } from "logos/journalling/logos/slowmode-upgrade";
import { SuggestionSendEventLogger } from "logos/journalling/logos/suggestion-send";
import { TicketOpenEventLogger } from "logos/journalling/logos/ticket-open";
