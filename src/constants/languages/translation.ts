...
const languageToLocale = {
	...
	lingvanex: {
		...
		Arabic: "ar",
		"Arabic/Egypt": "ar_EG",
		"Arabic/SaudiArabia": "ar_SA",
		"Arabic/UnitedArabEmirates": "ar_AE",
...
const localeToLanguage = {
	...
	lingvanex: reverseObject(languageToLocale.lingvanex),
};

function isLanguage(language: string): language is Language {
	for (const languagesMapped of Object.values(languageToLocale)) {
		if (language in languagesMapped) {
			return true;
		}
	}
